#!/usr/bin/env python3
#
# Program:      program_02b.py
#
# Objective:    GUI application template using buttons and labels
#               Only change the main program from program_01.py
#               ttk.Frame. Fix up frame layout with sticky
#
...
INFO_1 = "Program to highlight ttk.Frame and use of sticky."
...
class GUI_Application():
    ...
    def __init__(self, master, argument):
        ...
        self.label_3 = ttk.Label(self.frame_4, text=('{} "{}".'
        ...
        # ***program_02b adds the stickys below to better align the tk window
        ...
        self.frame_4.grid(row=2, column=0, columnspan=3, sticky="WE")
