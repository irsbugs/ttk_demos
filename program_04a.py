...
INFO_1 = ("Program to introduce the use of Checkbutton.\n"
...
class GUI_Application_Feature(ttk.Frame):
    ...
    def create_feature_widgets(self, argument):
        ...
        self.checkbutton_int_1 = IntVar()
        # *** Set Int variable for Checkbutton set 2
        self.checkbutton_int_2 = IntVar()
        ...
        if argument:
            self.checkbutton_int_1.set(0)
            self.checkbutton_int_2.set(1)
