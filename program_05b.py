...
INFO_1 = ("Enter widget validated to ensure input is lower case.\n"
...
class GUI_Application_Feature(ttk.Frame):
    ...
    def create_feature_widgets(self, argument):
        ...
        self.entry_1 = ttk.Entry(self.labelframe_1,
        ...
        self.entry_1.grid(
            in_=self.labelframe_1, row=0, column=0, padx=5, pady=5,)
