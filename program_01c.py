...
#               Complete migration of functionality. Change:
#               Labels on the buttons fro ON/Off to Inc/Dec
#               Add Enable and Disable of Inc and Dec buttons
#               Add fancy styles to Increment and Decrement buttons
#
#
...
class GUI_Application_Feature(ttk.Frame):
    ...
    def create_feature_widgets(self, argument):
        ...
        # Button Enable # ***
        self.button_3 = ttk.Button(self, text=BUTTON_3_TEXT,
                                   command=self.button_3_callback)
        # Button Disable # ***
        self.button_4 = ttk.Button(self, text=BUTTON_4_TEXT,
        ...
        self.button_4.grid(row=2, column=1, padx=10, pady=10, sticky="w")
