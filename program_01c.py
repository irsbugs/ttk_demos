#!/usr/bin/env python3
#
# Program:      program_01c.py
#
# Objective:    GUI application template using buttons and labels
#               Complete migrating program_01a to have different functionality.
#               Change the GUI aspects of program_01a/b.py.
#               Add more complex styles for the buttons style.
#               Add buttons to enable and disable other buttons.
#
...
# 2. #*** indicates a change between program_1b and program_1c
#
...
class GUI_Application():
    ...
    def __init__(self, master, argument):
        ...
        # Button to Enable #***
        self.button_5 = ttk.Button(master, text=BUTTON_5_TEXT,
                                   command=self.button_5_callback)
        # ===== Add widgets to grid =====
        # Labels
        ...
        self.button_3.grid(row=5, column=3, padx=10, pady=10)  # , sticky=E)
        self.button_4.grid(row=5, column=0, padx=10, pady=10)  # , sticky=E)
        self.button_5.grid(row=5, column=1, padx=10, pady=10)  # , sticky=E)
        # ===== Initial Setup =====
