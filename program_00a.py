...
INFO_1 = "Program to display the standard GUI application class."
...
class GUI_Application_Standard(ttk.Frame):
    ...
    def main_program_inside_GUI_class(self, status):
        """
        Assuming you want to pass a variable with status information then,
        To call this from inside the GUI Application:
        self.main_program_inside_GUI_class(status)
        To update the Label:
        self.label_1_standard.config(text=status)
        """
        pass
...
def main_program_outside_GUI_class(label1, status):
    """
    Assuming you want to pass a variable with status information and display
    the variable in label_1_standard then,
    To call this from inside the GUI Application:
    main_program_outside_GUI_class(label_1_standard, status)
    To update the Label:
...
if __name__ == "__main__":
    ...
    # main_gui = GUI_Application_Standard(root, argument_1).pack(fill="both",
    #                                                            expand=True)
    root.mainloop()
