...
class GUI_Application_Feature(ttk.Frame):
    ...
    def __init__(self, parent, argument):
        ...
        # Pack options:  after, anchor, before, expand, fill, in, ipadx, ipady,
        #                padx, pady, side.
        # Grid options:  column, columnspan, in, ipadx, ipady, padx, pady, row,
        #                rowspan, sticky
    ...
    def create_feature_widgets(self, argument):
        ...
        # ***
        self.entry_1.grid(row=1, column=0, padx=10, pady=5, sticky="w")
        ...
        if argument:
            self.entry_1_text.set("Account")
            # self.entry_2_text.set("Password")
    ...
    # ===== Widget call backs =====
    def entry_1_cb(self):
        """Entry_1 callback. Place value from variable into Label"""
        # Call back from Entry is not available in this program.
        # self.label_1.config(text=self.entry_1_text.get())
        pass
